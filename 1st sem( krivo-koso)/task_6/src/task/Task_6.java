...
public class Task_6 {
    ...
    public Class<BattleUnit> subtask_2_ClassProgramming() {
         ...
         *
         *      - void attacked(BattleUnit enemy) - атака юнитом enemy данного юнита (+)
         *
         * МЕТОДЫ ПЕРЕДВИЖЕНИЯ
    ...
    public Class<WebAddressParser> subtask_3_ClassProgramming() {
         ...
         *      - HashMap<String, String> getParameters() - возвращает словарь параметров с их значениями (+)
